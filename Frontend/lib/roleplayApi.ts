...
fetchWithAuth(`${API_URL}/api/roleplay/page/scenarios?is_admin=${isAdmin}`, {
 method: 'GET',
 headers: {
 'X-User-ID': userId,
...
try {
 const response = await
fetchWithAuth(`${API_URL}/api/roleplay/page/scenarios/${scenarioId}`, {
 method: 'DELETE',
 headers: {
 'X-User-ID': userId,
...
try {
 ...
 const response = await
fetchWithAuth(`${API_URL}/api/roleplay/page/scenarios/assign`, {
 method: 'POST',
 headers: {
 'X-User-ID': userId,
 'Content-Type': 'application/json',
