                ...
                <nav className="space-y-2">
                  {tabs.map((tab, index) => (
                    <button
                      ...
                      className={`w-full text-left px-4 py-4 rounded-lg transition-all flex items-center gap-3 ${activeTab === tab.id
                      ...
                      <div className="grid grid-cols-5 gap-2 mb-4">
                        {cutoffScorePresets.map((preset) => (
                          <button
                            ...
                            className={`p-3 rounded-lg border-2 transition-all text-center ${formData.cutoffScore === preset.value
