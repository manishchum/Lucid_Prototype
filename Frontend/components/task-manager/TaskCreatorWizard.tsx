                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-md">
                    <button
                      ...
                      className={`p-4 rounded-xl text-left border cursor-pointer transition-all flex items-start space-x-3 ${
                        associateWithSprint
                          ? 'border-[#2F63FF] bg-[#EEF2FF] shadow-sm shadow-blue-50'
                          : 'border-[#E2E8F0] hover:border-gray-300 hover:bg-slate-50'
                      }`}
                    >
                      <div className={`p-2.5 rounded-lg ${associateWithSprint ? 'bg-[#2F63FF] text-white' : 'bg-gray-100 text-gray-600'}`}>
                        <Layers size={18} />
                      </div>
                      <div className="flex-1">
                        <span className="text-xs font-semibold text-[#0F172A] font-sans block">Yes, associate with Sprints</span>
                        <p className="text-[10px] text-gray-500 mt-0.5 font-sans">Link this task flow to one or more active training sprint cycles.</p>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <span className="text-xs font-semibold text-[#0F172A] font-sans block">No sprint association</span>
                        <p className="text-[10px] text-gray-500 mt-0.5 font-sans">Create a general task flow independent of specific sprint schedules.</p>
                      </div>
                    </button>
                  </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="p-3 border border-gray-200 rounded-xl bg-white space-y-2">
                          ...
                          <div className="space-y-1">
                            {corporateLevels.functions.map((func) => {
                    ...
                    <div className="p-5 bg-gradient-to-br from-[#0F172A] to-[#1E293B] text-white rounded-2xl space-y-4">
                      ...
                      <div className="space-y-4 text-xs">
                        <div className="flex justify-between border-b border-white/10 pb-2">
                          <span className="text-gray-400">Sprint Association</span>
                          <span className="font-mono text-[#E0E7FF] font-semibold uppercase">
                            {associateWithSprint ? `${selectedSprintIds.length} Sprints` : 'No'}
                          </span>
                        </div>
                        <div className="flex justify-between border-b border-white/10 pb-2">
                        ...
                        <div className="flex justify-between border-b border-white/10 pb-2">
                          ...
                          <span className="font-mono text-[#E0E7FF] font-semibold truncate max-w-[150px]">
                            {selectedIndividualIds.length > 0 ? `${selectedIndividualIds.length} users` : 'All filtered personnel'}
                          </span>
                        </div>
                        <div className="flex justify-between border-b border-white/10 pb-2">
