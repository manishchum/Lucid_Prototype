...
export function useFeatureGating() {
  ...
  const hasFeature = (featureName: string): boolean => {
    const features: Record<string, FeatureConfig> = {
      ...
      'taskManagementTextual': { requiredAddons: ['task_management_textual'] },
      'taskManagementImage': { requiredAddons: ['task_management_image'] },
      'taskManagementEvaluation': { requiredAddons: ['task_management_evaluation'] },
      'taskManagementAudio': { requiredAddons: ['task_management_audio'] },
      'taskManagementVideo': { requiredAddons: ['task_management_video'] },
      'baselineAssessment': { requiredAddons: ['baseline_assessment'] },
