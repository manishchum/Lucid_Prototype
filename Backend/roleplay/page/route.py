...
async def delete_scenario(
    ...
    try:
        ...
        scenario_result = roleplay_db.verify_scenario_company(scenario_id, effective_company_id)
...
async def assign_scenario_to_targets(
    ...
    try:
        ...
        if assignment_type == 'user':
            ...
            existing_result = roleplay_db.get_existing_user_assignments(
                scenario_id,
                company_id,
                target_ids
            )
        ...
        # Insert assignments
        insert_result = roleplay_db.insert_assignments(assignments)
