...
def clean_transcript_with_gemini(
    transcript: str,
    task_title: str,
    ...
    prompt = f"""
        You are an expert speech-to-text transcript corrector.
        The transcript below was generated by an automatic speech recognition (ASR) model.
        Task Title:
        {task_title}
        Task Description:
        {task_description}
        ...
        - Use the task context only to understand terminology and likely vocabulary.
        - Do NOT invent information.
        - Do NOT summarize.
        - Do NOT rewrite the response unnecessarily.
        - Do NOT guess unclear words.
        - If you are not highly confident about a correction, keep the original word.
        - Return ONLY the corrected transcript.
        - Preserve the speaker's style and wording as much as possible.
        - Do not make the response sound more formal.
        - Only correct clear transcription mistakes, grammar, and punctuation.
        Transcript:
        {transcript}
        """
    try:
        ...
        print("[Transcript Cleaner Error]", e)
        return transcript
